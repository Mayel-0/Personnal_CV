...
<template>
  <div class="Contacts">
    <transition name="fade">
      <h1 v-if="ShowTitle" >{{ currentTexts.titleContact }}</h1>
    </transition>
    <transition name="fade">
      <div v-if="ShowContacts" class="ContactAll">
        ...
        <div class="Links">
          ...
          <a class="Link Github" href="https://github.com/Mayel-0">
            Github
          ...
          <a class="Link Mail" href="mailto:llado.mael33@gmail.com?subject=Contact%20depuis%20le%20site%20:&body=Bonjour,%0AJe%20vous%20contacte%20concernant...">
            Gmail
          ...
          <a class="Link instagrame" href="https://www.instagram.com/mayel__0/">
            Instagram
          ...
          <div class="text">{{ currentTexts.textContact }}</div>
        </div>
      </div>
    </transition>
  </div>
