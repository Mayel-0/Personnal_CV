...
function SecretPage(secretCount) {
  if(secretCount == 5) {
    console.log("secret page ON !")
    window.location.href = `/${props.lang}/secret`;
  }else {
  ...
  <div class="ProjectPage">
    <div class="IntroProj">
      <transition name="fade">
        <svg @click="SecretPage(secretCount), secretCount += 1" v-if="ShowTitle" width="32" height="31" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg">
