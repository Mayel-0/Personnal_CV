...
watch(
  ...
  (newVal) => {
    if (
      ...
      !Containeur2.value ||
      !ContaineurContact.value ||
      !containeur1Presentation.value ||
      !containeur2Presentation.value ||
      !containeur3Presentation.value ||
      !PhoneV.value ||
      !Containeur1PhoneV.value ||
      !Containeur2PhoneV.value ||
      !Containeur3PhoneV.value ||
      !Containeur4PhoneV.value
    )
      return;
...
<template>
  <main>
    ...
    <div
      ...
      ref="Containeur1"
      :class="{
        'containeur1--animated': !props.isContactOpen,
        'containeur1--animated-out':
          props.isContactOpen || props.animationout || props.isPresentationOpen,
      }"
    >
      <h2>Mon site web</h2>
    ...
    <div
      class="Contacts"
      ref="ContaineurContact"
      :class="{
        'Contact--animated': props.isContactOpen,
        'Contact--animated-out': !props.isContactOpen,
      }"
    >
      <div class="Links">
        <a
          ...
          @mouseenter="ShowSVG = true"
          @mouseleave="ShowSVG = false"
        >
          Linkedin
          <svg
            class="iconLogo"
    ...
    <div
      ...
      ref="Containeur2"
      :class="{
        'containeur2--animated': !props.isContactOpen,
        'containeur2--animated-out':
          props.isContactOpen || props.animationout || props.isPresentationOpen,
      }"
    >
      <h2>À propos de moi</h2>
      <p>
        Bonjour, je m’appelle <strong>Maël LLADO.</strong> Je suis actuellement étudiant à l’école
        privée <strong>Ynov Campus Bordeaux</strong>, après avoir obtenu mon
    ...
    <div
      class="containeur presentation"
      ref="containeur1Presentation"
      :class="{
        'animated-presentation1': props.isPresentationOpen,
        'animated-presentation1-out': !props.isPresentationOpen,
      }"
    >
      ...
      <p>
        ...
        et appris le <strong>HTML, CSS, SCSS et le JavaScript</strong> , en réalisant plusieurs
        sites en <strong>Vue.js.</strong>

        J’ai également effectué d’autres stages en maintenance informatique et en boutique
        spécialisée, ce qui m’a permis d’élargir mes compétences.
      </p>
    </div>
    <div
      class="containeur presentation"
      ref="containeur2Presentation"
      :class="{
        'animated-presentation2': props.isPresentationOpen,
        'animated-presentation2-out': !props.isPresentationOpen,
      }"
    >
      <h2>Projets personnels</h2>
      <p>
        En autodidacte, j’ai appris le <strong>Python</strong> et développé un de mes plus gros
        projets : un logiciel de <strong>reconnaissance faciale</strong>, présenté à l’oral de mon
        Bac. Ce projet m’a permis d’apprendre à utiliser <strong>GitHub</strong> et à structurer mon
        code comme un vrai développeur. J’ai aussi expérimenté
        <strong>la programmation de jeux vidéo avec Unreal Engine 5</strong>, par curiosité et pour
        élargir mes connaissances.
      </p>
    </div>
    <div
      class="containeur presentation"
      ref="containeur3Presentation"
      :class="{
        'animated-presentation1': props.isPresentationOpen,
        'animated-presentation1-out': !props.isPresentationOpen,
      }"
    >
      ...
      <p>
        ...
        <strong>développement web, full-stack</strong> qu’en
        <strong>programmation de jeux vidéo</strong>, qui sont les sujets qui m’intéressent le plus.
        J’ai également une première expérience en <strong>cybersécurité</strong>, grâce à mes trois
        années de Bac Pro SN RISC, à ma participation à des <strong>CTF</strong> et à mes recherches
        personnelles. Curieux et motivé, j’aime relever de nouveaux défis et je souhaite évoluer
        vers un métier passionnant dans le développement informatique.
      </p>
    </div>
    <div class="PhoneVersionAffichage">
      <div
        class="containeur presentation"
        ref="Containeur1PhoneV"
        :class="{
          'animated-presentation1': props.isPresentationOpen,
          'animated-presentation1-out': !props.isPresentationOpen,
        }"
      >
        ...
        <p>
          Bonjour, je m’appelle <strong>Maël LLADO.</strong> Je suis actuellement étudiant à l’école
          privée <strong>Ynov Campus Bordeaux</strong>, après avoir obtenu mon
          <strong>Baccalauréat Professionnel SN (Systèmes Numériques), option RISC</strong> , avec
          la <strong>mention Très Bien</strong>, au lycée polyvalent Jean-Monnet de Libourne.
        </p>
      </div>
      <div
        class="containeur presentation"
        ref="Containeur2PhoneV"
        :class="{
          'animated-presentation1': props.isPresentationOpen,
          'animated-presentation1-out': !props.isPresentationOpen,
        }"
      >
        <h2>Parcours et expériences</h2>
        <p>
          Passionné d’informatique depuis le collège, j’ai orienté mon parcours vers la
          programmation. Lors de mes stages chez <strong>Snark Factory</strong>, j’ai découvert le
          développement web et appris le <strong>HTML, CSS, SCSS et le JavaScript</strong> , en
          réalisant plusieurs sites en <strong>Vue.js.</strong>
      ...
      >
        ...
        <p>
          En autodidacte, j’ai appris le <strong>Python</strong> et développé un de mes plus gros
          projets : un logiciel de <strong>reconnaissance faciale</strong>, présenté à l’oral de mon
          Bac. Ce projet m’a permis d’apprendre à utiliser <strong>GitHub</strong> et à structurer
          mon code comme un vrai développeur. J’ai aussi expérimenté
          <strong>la programmation de jeux vidéo avec Unreal Engine 5</strong>, par curiosité et
          pour élargir mes connaissances.
        </p>
      </div>
      <div
        class="containeur presentation"
        ref="Containeur4PhoneV"
        :class="{
          'animated-presentation1': props.isPresentationOpen,
          'animated-presentation1-out': !props.isPresentationOpen,
        }"
      >
        ...
        <p>
          ...
          domaines de l’informatique. Je souhaite devenir <strong>polyvalent</strong>, aussi bien en
          <strong>développement web, full-stack</strong> qu’en
          <strong>programmation de jeux vidéo</strong>, qui sont les sujets qui m’intéressent le
          plus. J’ai également une première expérience en <strong>cybersécurité</strong>, grâce à
          mes trois années de Bac Pro SN RISC, à ma participation à des <strong>CTF</strong> et à
          mes recherches personnelles. Curieux et motivé, j’aime relever de nouveaux défis et je
          souhaite évoluer vers un métier passionnant dans le développement informatique.
        </p>
      </div>
    </div>
    <div class="PhoneversionAnnexes" ref="PhoneAnnexes">
      <div
        class="FichiersD"
        :class="{
          'containeur1--animated': props.isAnnexeOpen,
          'containeur1--animated-out': !props.isAnnexeOpen,
        }"
      >
      ...
      <div
        class="FichiersD"
        :class="{
          'containeur2--animated': props.isAnnexeOpen,
          'containeur2--animated-out': !props.isAnnexeOpen,
        }"
      >
